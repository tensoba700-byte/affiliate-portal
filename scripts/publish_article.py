...
2. 商品紹介文（description）は各商品250文字以上。以下を含めること：
   - テレワーク・長時間集中作業・在宅勤務などの具体的なシーン
   - 競合製品と比べた具体的な優位点（例：「従来モデルより〇〇が△△改善」）
   - 実際に使ったときにしか分からない「違い」や「感動ポイント」
   - 購買欲を高めるポジティブな語尾（「おすすめです！」「必携アイテム」など）

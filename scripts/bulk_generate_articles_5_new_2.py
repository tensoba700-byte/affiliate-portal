...
# 新規5記事の定義 (1日2投稿の続き: 2026-08-10 19:00 〜 2026-08-12 19:00)
targets = [
    {
        "page_id": "3aaddb45-8772-812a-a6bd-e731709ae931",
        "keyword": "マスカラ",
        "slug": "mascara",
    ...
    {
        "page_id": "3aaddb45-8772-8134-a9c5-c9f04bf4f1c1",
        "keyword": "眉マスカラ",
    ...
    {
        "page_id": "3aaddb45-8772-813a-902a-e6ff345d4f7c",
        "keyword": "BBクリーム",
        "slug": "bb-cream",
    ...
    {
        "page_id": "3aaddb45-8772-8114-bada-fed200b149b1",
        "keyword": "炭酸洗顔",
        "slug": "carbonated-wash",
        "date": "2026-08-12 08:00:00",
        "category": "美容・スキンケア"
    },
    {
        "page_id": "3aaddb45-8772-81d6-bff1-cc52ef6779dc",
        "keyword": "乾燥肌向け洗顔料",
        "slug": "dry-skin-wash",
...
def main():
    ...
    print(f"🏁 Starting safe batch article generation for {len(targets)} new targets.")
    ...
    for idx, target in enumerate(targets):
        ...
        print("\n" + "="*80)
        print(f"🔄 [{idx+1}/{len(targets)}] Processing: {keyword} ({slug}) | Scheduled: {date}")
        print("="*80)
        
        # 古い stockpile_data.json のクリーンアップ
    ...
    print("\n🏁 Safely completed batch article generation for 5 new targets!")

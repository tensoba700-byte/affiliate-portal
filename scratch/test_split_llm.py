...
def load_generation_rules():
    rules_path = "GENERATION_RULES.md"
...
出力形式: JSONスキーマに完全に従ってください。"""
    ...
    # 4. Output complete article data
    final_article = {
    ...
    with open("split_generated_article.json", "w", encoding="utf-8") as f:
        json.dump(final_article, f, ensure_ascii=False, indent=2)
    print("🎉 Done! Saved split generated article to split_generated_article.json")
